...
<div class="space-y-5">
    <div>
        ...
        <input type="text" name="name" value="<?php echo e(old('name', $p?->name)); ?>"
    ...
    <div class="grid grid-cols-2 gap-4">
        <div>
            ...
            <select name="category" class="form-input" required>
                ...
                <option value="<?php echo e($cat); ?>" <?php echo e(old('category', $p?->category) === $cat ? 'selected' : ''); ?>>
        ...
        <div>
            ...
            <input type="number" name="price" value="<?php echo e(old('price', $p?->price)); ?>"
    ...
    <div class="grid grid-cols-2 gap-4">
        <div>
            ...
            <input type="number" name="stock" value="<?php echo e(old('stock', $p?->stock ?? 0)); ?>"
                class="form-input" min="0" required>
        </div>
        <div>
            <label class="form-label">Low Stock Threshold</label>
            <input type="number" name="low_stock_threshold" value="<?php echo e(old('low_stock_threshold', $p?->low_stock_threshold ?? 10)); ?>"
    ...
    <div>
        ...
        <textarea name="description" rows="3" class="form-input resize-none"
            placeholder="Optional description..."><?php echo e(old('description', $p?->description)); ?></textarea>
    </div>

    <div class="flex items-center gap-3 bg-foam p-4 rounded-xl">
        <input type="checkbox" name="is_available" id="is_available" value="1"
            <?php echo e(old('is_available', $p?->is_available ?? true) ? 'checked' : ''); ?>
...
<?php /**PATH C:\xampp\htdocs\coffee-shop\resources\views/admin/products/_form.blade.php ENDPATH**/ ?>
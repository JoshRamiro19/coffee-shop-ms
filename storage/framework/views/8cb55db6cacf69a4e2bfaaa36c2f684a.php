...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'BrewHouse'); ?> — Coffee Shop</title>
...
<nav class="bg-espresso shadow-lg sticky top-0 z-40">
    <div class="max-w-screen-2xl mx-auto px-6 flex items-center justify-between h-16">
        <a href="<?php echo e(route('orders.index')); ?>" class="flex items-center gap-3">
        ...
        <div class="flex items-center gap-1">
            <a href="<?php echo e(route('orders.index')); ?>" class="nav-link px-4 py-2 text-sm text-gray-300 <?php echo e(request()->routeIs('orders.index') ? 'active text-caramel' : ''); ?>">
                <i class="fas fa-receipt mr-1"></i> Orders
            </a>
            <a href="<?php echo e(route('orders.queue')); ?>" class="nav-link px-4 py-2 text-sm text-gray-300 <?php echo e(request()->routeIs('orders.queue') ? 'active text-caramel' : ''); ?>">
                <i class="fas fa-list-ol mr-1"></i> Queue
                <?php $queueCount = \App\Models\Order::whereIn('status',['queue','preparing'])->count(); ?>
                <?php if($queueCount > 0): ?>
                    <span class="ml-1 bg-caramel text-white text-xs font-bold px-2 py-0.5 rounded-full"><?php echo e($queueCount); ?></span>
                <?php endif; ?>
            </a>
            <a href="<?php echo e(route('admin.dashboard')); ?>" class="nav-link px-4 py-2 text-sm text-gray-300 <?php echo e(request()->routeIs('admin.*') ? 'active text-caramel' : ''); ?>">
...
<div class="fixed top-20 right-5 z-50 bg-red-50 border border-red-200 text-red-800 px-5 py-3 rounded-xl shadow-lg animate-in">
    <?php $__currentLoopData = $errors->all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $error): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="flex items-center gap-2"><i class="fas fa-exclamation-circle text-red-500"></i> <?php echo e($error); ?></div>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
</div>
<?php endif; ?>

<main class="<?php echo $__env->yieldContent('main-class', 'max-w-screen-2xl mx-auto px-6 py-8'); ?>">
...
<?php /**PATH C:\xampp\htdocs\coffee-shop\resources\views/layouts/app.blade.php ENDPATH**/ ?>